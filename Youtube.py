api_key='AIzaSyBn_PzVj1COqsAJXBA5FOoYwCqTE-Y54Dg' #your api key
...
#port = '5432'
##username = 'postgres'
#password = 'ramakrishnan'
#creating connection with postgresql 
eta = psycopg2.connect(host="localhost", port="5432", database="youtube", user="postgres", password="ramakrishnan")
cursor=eta.cursor()
...
omega=pymongo.MongoClient("mongodb+srv://ramakrishnan:rramakrishnan@cluster0.ahzmf9f.mongodb.net/?retryWrites=true&w=majority")#enter the connection link from mongodb
